...
class Match:
    ...
    def run(self, team1, team2, num_player=1, max_frames=MAX_FRAMES, max_score=3, record_fn=None, record_fn2=None, timeout=1e10,
        ...
        for it in range(max_frames):
            ...
            if record_fn2:
                self._r(record_fn2)(team1_state, team2_state, soccer_state=soccer_state, actions=actions,
                                   team1_images=team1_images, team2_images=team2_images)
...
if __name__ == '__main__':
    ...
    if args.parallel is None or remote.ray is None:
        ...
        if args.record_video:
            recorder1 = recorder1 & utils.VideoRecorder(args.record_video)

        if args.record_state:
            recorder2 = recorder2 & utils.StateRecorder(args.record_state)
        ...
        try:
            result = match.run(team1, team2, args.num_players, args.num_frames, max_score=args.max_score,
                               ...
                               record_fn=recorder1, record_fn2=recorder2)
            print('Match Run')
